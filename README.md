...
- `index.html` — the entire site. A single-page app with hash-based routing (`#home`, `#broodi`, `#nutriroots`, `#pethealth`, `#services`, `#work`, `#staff`, `#contact`). Legacy `#websites` and `#consulting` links redirect to sections of `#services`. No build step, no dependencies.
